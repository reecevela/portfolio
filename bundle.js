...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var techTags = ["Django", "GPT API", "Python", "Postgres", "Cloud Deployment", "Databases", "Linux", "Git", "JS", "HTML", "CSS", "Nginx", "Gunicorn"];
